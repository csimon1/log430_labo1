 ...
 * active resources, and each line of input is read and expected in the
 * following format: a field oriented and space-separated text file that lists
 * all the resources. The fields are as follows:
 * 
 * <pre>
...
public class ResourceReader extends LineOfTextFileReader {
	 ...
	 * where it is parsed and a Resource object is returned. The Resource object
	 * is then added to the list. When a null is read from the Resource file the
	 ...
	 *            the list of ressources to read
	 */
